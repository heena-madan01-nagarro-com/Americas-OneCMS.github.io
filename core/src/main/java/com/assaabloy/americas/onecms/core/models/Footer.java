...
/**
 * Defines the {@code Footer} Sling Model used for the {@code onecms/components/content/footer} component.
 * 
 */
@ConsumerType
    ...
    extends ComponentExporter
{
    ...
    String getCopyrightLogo();

    List<CopyrightLink> getCopyrightLinks();
