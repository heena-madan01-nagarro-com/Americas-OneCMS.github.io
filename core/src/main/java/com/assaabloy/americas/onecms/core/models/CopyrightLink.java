...
/**
 * Defines the {@code CopyrightLink} Sling Model used for the multifield in {@code onecms/components/content/footer} component.
 * 
 */
@ConsumerType
public interface CopyrightLink
    extends ComponentExporter
{


    String getCopyrightItemURL();

    String getCopyrightItemLabel();
